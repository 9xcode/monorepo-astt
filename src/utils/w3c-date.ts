 ...
 * @param fallback What to return if d is missing/invalid (default: siteConfig.buildTime)
 */
export function formatW3CDate(d: string | Date | undefined, fallback: string = siteConfig.buildTime): string {
