 ...
 *
 * Common utilities (getReadTime, filterTocHeadings, resolveSlug) live in
 * content.ts and slug.ts respectively — import from there directly.
 */
 ...
 *
 * @param current - The currently viewed BlogPost.
 * @param all     - All published posts (from getAllPosts()).
 * @param count   - Maximum number of related posts to return. Default: 3.
 * @returns Up to `count` BlogPost objects, always at least 1 if any posts exist.
 */
