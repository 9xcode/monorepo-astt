<script lang="ts">
  ...
  const computed = $derived.by(() => {
    return buildSocialUrl(username, 'https://bere.al/');
  });
...
<div class="space-y-5">
  <div class="space-y-1.5">
    <label for="bereal-input" class="block text-xs font-semibold uppercase tracking-wide text-muted-foreground">
      BeReal Username <span class="text-emerald-500 normal-case tracking-normal font-medium ml-0.5">*</span>
    </label>
    <input
      id="bereal-input"
      type="text"
