...
<div class="space-y-5">
  <div class="space-y-1.5">
    <label for="discord-input" class="block text-xs font-semibold uppercase tracking-wide text-muted-foreground">
      Discord Server Invite URL <span class="text-emerald-500 normal-case tracking-normal font-medium ml-0.5">*</span>
    </label>
    <input
      id="discord-input"
      type="url"
    ...
    <p class="text-[11px] text-muted-foreground/60 leading-relaxed">
      Encode a link to your Discord profile or page.
    </p>
  </div>
