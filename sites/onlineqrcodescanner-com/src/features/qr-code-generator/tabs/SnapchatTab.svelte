<script lang="ts">
  ...
  const computed = $derived.by(() => {
    return buildSocialUrl(username, 'https://snapchat.com/add/');
  });
...
<div class="space-y-5">
  <div class="space-y-1.5">
    <label for="snapchat-input" class="block text-xs font-semibold uppercase tracking-wide text-muted-foreground">
      Snapchat Username <span class="text-emerald-500 normal-case tracking-normal font-medium ml-0.5">*</span>
    </label>
    <input
      id="snapchat-input"
      type="text"
