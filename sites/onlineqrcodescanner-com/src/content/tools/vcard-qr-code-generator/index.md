...
## vCard vs. a QR code that links to your website
...
- [Wi-Fi QR Code Generator](/tools/wifi-qr-code-generator) - let guests join your network by scanning instead of typing a password
...
- [Email QR Code Generator](/tools/email-qr-code-generator) - generate a QR code that pre-fills an email draft to your address
