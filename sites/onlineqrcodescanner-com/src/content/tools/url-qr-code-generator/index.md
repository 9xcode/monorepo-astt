...
- [QR Code Generator](/tools/qr-code-generator) - the main hub for all QR types: URL, text, Wi-Fi, email, phone, SMS, vCard, and Bitcoin
- [Text QR Code Generator](/tools/text-qr-code-generator) - encode a plain message instead of a clickable link
- [Wi-Fi QR Code Generator](/tools/wifi-qr-code-generator) - let people connect to a network without typing the password
- [vCard QR Code Generator](/tools/vcard-qr-code-generator) - share contact details in a format phones can import directly
...
### Can I create a QR code from a link for free?
