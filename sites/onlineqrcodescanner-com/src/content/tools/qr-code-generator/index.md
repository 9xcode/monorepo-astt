...
5. **Download or copy**: click Download to save the file, or the copy button to paste the image directly into another app.
...
For a complete breakdown of the vCard format and which fields map to what, see the [vCard QR Code Generator](/tools/vcard-qr-code-generator) page.
